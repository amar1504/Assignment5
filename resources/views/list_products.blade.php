...
<link href="list_products.blade_files/default.css" rel="stylesheet" type="text/css" media="all">
<link href="list_products.blade_files/stylesheet.css" rel="stylesheet" type="text/css" media="all">
...
<script src="list_products.blade_files/jquery.js"></script>
<!-- bxSlider Javascript file -->
<script src="list_products.blade_files/jquery_003.js"></script>
<script src="list_products.blade_files/script.js" type="text/javascript"></script>

<!-- bxSlider CSS file -->
<link href="list_products.blade_files/jquery.css" rel="stylesheet">
<!-- Responsive -->
<link href="list_products.blade_files/responsive.css" rel="stylesheet">
  ...
  <header class="clearfix header_fixed">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Logo_Cont left"><!--Logo_Cont Start-->
           ...
           <a href="http://wireframes.php-dev.in/training/v1.2/php/assignment/index.html"><img src="list_products.blade_files/logo.png" alt=""></a>
				...
				<table width="100%">
					...
					<tbody>
						<tr>
							...
							<td>Iphone</td>
							<td style="text-align:center"><img src="list_products.blade_files/noimage.jpg" style="width:80px; height:auto;"></td>
...
<div class="section clearfix section-colored7"><!--section start--> 
	...
	<div class="container"><!--container Start-->
		...
		<div class="Download_Cont_Top_Left left"><!--Download_Cont_Top Start-->
			<img src="list_products.blade_files/icon5.png" alt=""> <h1 style="display:inline;">FREE: Men Are From Mars</h1> <a href="#">Download Now</a>
  ...
  <footer class="footer_wrapper">
    ...
    <div class="container"><!--container Start-->
		...
		<div class="Footer_Cont_Top clearfix"><!--Footer_Cont_Top Start-->
			...
			<span class="left"><img src="list_products.blade_files/foot_logo.png" alt=""></span>
...
Live a life without regrets and take action today!</p>
		...
		<div class="Footer_Cont_Top2 clearfix"><!--Footer_Cont_Top2 Start-->
			...
			<h1>Call Us Today! (02) 9017 8413</h1>
			 <a href="#">Book an Appointment <img src="list_products.blade_files/icon7.png" alt=""></a>
 			 <a href="#">Contact a Consultant <img src="list_products.blade_files/icon6.png" alt=""></a>
...
<script type="text/javascript" src="list_products.blade_files/jquery_002.js"></script>	
